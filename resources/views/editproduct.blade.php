            ...
            <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col gap-3 mt-3 appearance-none">
                    <input type="text" id="nama_produk"
                        ...
                        name="nama_produk" value="{{ $produk->nama_produk }}" placeholder="Nama Produk" required autofocus>
                    <div class="relative">
                        <select
                    ...
                    <input type="number" id="stok_produk"
                        ...
                        name="stok_produk" value="{{ $produk->stok_produk }}" placeholder="Stok" required autofocus>
                    <input type="number" id="harga_produk"
                        ...
                        name="harga_produk" value="{{ $produk->harga_produk }}" placeholder="Harga" required autofocus>
