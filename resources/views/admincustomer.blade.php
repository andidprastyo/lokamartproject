...
<div class=" mx-auto mb-5 mt-10 py-5 px-5 w-[150vh] overflow-x-auto shadow-md bg-white h-[80vh] rounded-[20px]">
    <div class="flex items-center justify-between pb-4 bg-white dark:bg-gray-900">
        ...
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-4 mr-2 mb-2">Add Customer</button>
    </div>
