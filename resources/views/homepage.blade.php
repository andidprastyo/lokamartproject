...
<div class="mx-auto my-[5rem] grid grid-cols-4 gap-[5rem]">
    <div class="w-[15rem] drop-shadow-lg max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="rounded-t-lg" src="{{asset('img/produk.png')}}" alt="" />
        </a>
        <div class="px-5 mt-3 pb-5 text-center">
            <a href="#">
                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Rengginang</h5>
            </a>
...
<div class="justify-center mx-auto mb-[5rem]">
    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-lg px-8 py-4 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View All</button>
</div>
